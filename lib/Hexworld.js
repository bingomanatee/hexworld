...
class HexWorld {
  ...
  edgePeers(vertex) {
    console.log('vertex:', vertex.zone.vertexToString(vertex));
    console.log('edge: from ', vertex.zone.vertexToString(vertex.edge[0]));
    console.log('edge: to ', vertex.zone.vertexToString(vertex.edge[1]));
